...
extension KlaviyoAPI.KlaviyoRequest {
    ...
    public enum KlaviyoEndpoint: Equatable, Codable {
        public struct CreateProfilePayload: Equatable, Codable {
            public init(data: KlaviyoAPI.KlaviyoRequest.KlaviyoEndpoint.CreateProfilePayload.Profile) {
                self.data = data
            }
...
//                ]
        ...
        public struct PushTokenPayload: Equatable, Codable {
            public init(data: KlaviyoAPI.KlaviyoRequest.KlaviyoEndpoint.PushTokenPayload.PushToken) {
                self.data = data
            }
