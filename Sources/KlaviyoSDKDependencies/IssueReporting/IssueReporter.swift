...
public enum IssueReporters {
  ...
  @TaskLocal fileprivate static var _current = IssueReportingLockIsolated<[any IssueReporter]>([.runtimeWarning])
}
...
public func withIssueReporters<R>(
  ...
  try IssueReporters.$_current.withValue(IssueReportingLockIsolated(reporters), operation: operation)
}
...
public func withIssueReporters<R>(
  ...
  try await IssueReporters.$_current.withValue(IssueReportingLockIsolated(reporters), operation: operation)
}
