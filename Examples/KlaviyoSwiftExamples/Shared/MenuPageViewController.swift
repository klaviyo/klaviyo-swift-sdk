...
class MenuPageViewController: UIViewController {
    ...
    @IBOutlet private weak var cartIcon: UIButton!
    @IBOutlet private weak var emailLabel: UILabel!
    @IBOutlet private weak var zipcode: UILabel!
    @IBOutlet private weak var tableView: UITableView!
    @IBOutlet private weak var logOutButton: UIButton!
    
    private let cart : Cart = Cart()
    ...
    private func saveCartItems(_ notification: Notification) {
        ...
        if !cart.cartItems.isEmpty {
            ...
            let itemsPurchasedArray = cart.createCartItemsSet.map { $0.name }
