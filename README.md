...
To be able to send push notifications, you must add few snippets of code to your application. One to register users for push notifications, and one that will send Klaviyo their tokens. 
