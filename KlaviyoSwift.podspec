Pod::Spec.new do |s|
  ...
  s.source_files = [
    'Sources/KlaviyoSwift/**/*.swift',
    'Sources/KlaviyoAutomaticPushBootstrap/**/*.{h,m}'
  ]
  s.public_header_files = 'Sources/KlaviyoAutomaticPushBootstrap/include/KlaviyoAutomaticPushBootstrap.h'
  ...
  s.dependency     'KlaviyoCore', '~> 5.5.0'
