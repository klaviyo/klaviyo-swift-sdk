...
final class KlaviyoStateTests: XCTestCase {
    ...
    func testFullKlaviyoStateEncodingDecodingIsEqual() throws {
        ...
        // The persisted blob is queue-only: `apiKey`/`identity`/`pushToken` are owned by the Core
        // stores and are not round-tripped through the state file. The queue must survive intact.
