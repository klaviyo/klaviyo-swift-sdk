...
final class KlaviyoStateTests: XCTestCase {
    ...
    let TEST_INVALID_CUSTOMER_PROPERTIES_EVENTTEST_INVALID_CUSTOMER_PROPERTIES_EVENTTEST_INVALID_CUSTOMER_PROPERTIES_EVENTTEST_INVALID_CUSTOMER_PROPERTIES_EVENTTEST_INVALID_CUSTOMER_PROPERTIES_EVENT = [
        "event": "$opened_push",
        "properties": [
            "fo": "propValue"
        ],
