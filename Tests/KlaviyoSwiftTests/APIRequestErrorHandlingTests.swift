...
class APIRequestErrorHandlingTests: XCTestCase {
    ...
    func testSendRequestInternalRequestError() async throws {
        ...
        environment.klaviyoAPI.send = { _, _ in .failure(.internalRequestError(KlaviyoAPI.KlaviyoAPIError.internalError("foo"))) }
    ...
    func testSendRequestUnknownError() async throws {
        ...
        environment.klaviyoAPI.send = { _, _ in .failure(.unknownError(KlaviyoAPI.KlaviyoAPIError.internalError("foo"))) }
    ...
    func testRateLimitErrorWithExistingRetry() async throws {
        ...
        environment.klaviyoAPI.send = { _, _ in .failure(.rateLimitError(nil)) }
    ...
    func testRetryWithRetryAfter() async throws {
        ...
        environment.klaviyoAPI.send = { _, _ in .failure(.rateLimitError(20)) }
