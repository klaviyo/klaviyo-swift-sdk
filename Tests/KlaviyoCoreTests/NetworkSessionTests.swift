...
class NetworkSessionTests: XCTestCase {
    ...
    func testGetPluginConfigurationWithValidPlist() {
        ...
        do {
            ...
            XCTAssertEqual(result, "FooApp/1.2.3 (com.klaviyo.fooapp; build:1; iOS 1.1.1) klaviyo-swift/5.0.0 (test-plugin/1.0.0)")
    ...
    func testGetPluginConfigurationWithMissingPlist() {
        ...
        XCTAssertEqual(result, "FooApp/1.2.3 (com.klaviyo.fooapp; build:1; iOS 1.1.1) klaviyo-swift/5.0.0")
    }
